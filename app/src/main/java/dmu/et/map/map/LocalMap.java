...
public class LocalMap extends GeoMap{
    ...
    public static Pair<Integer, Integer> gpsToMap(Location loc, RectF display){
        return LocalMap.getDisplayCordinate((float)loc.getLatitude(),(float)loc.getLongitude(), display);
    }
}
